...
console.log( 과일상자 )       // undefined : 변수가 선언되었지만 초기값이 없다.
let 채소상자 = null           // 변수선언ok 초기화ok ,
console.log( null )           // null

// [5] 배열 , 순서대로 나열
// [ ] 대괄호 안에 , 쉼표 이용하여 여러개 자료들을 *하나의 자료* 표현, *중첩 가능*
// 인덱스(색인) : [ ] 해당 배열 내 저장된 자료들의 순서번호 , * 0번 부터 시작 *
...
console.log( 배열변수 )
배열변수[0] = '유재석2'                 // 0번자리에 유재석을 유재석2로 변경한다
...
console.log( 10 + "" ) 
// JAVA/PYTHON/API(외부자료) 들을 통신한경우
// JSON.parse( 통신결과물 ) 

// [7] 연산자 *한달안에 암기*
// 1. 산술연산자 : +더하기 -뺴기 *곱하기 /나누기 %나머지    , 컴퓨터는 % 모른다.
// 2. 연결연산자 : +연결연산자
...
// 7. 삼항연산자 : 조건 ? 참 : 거짓     ,   true 와 false 다른값으로 표현하고 싶을떄    ,   조건A ? 참A : 조건B ? 참B : 조건C ? : 참C : 거짓
//  * 점수 = 90 ? '합격' : '불합격'
...
// 증감연산자 , 순차적인 증가/감소 반복문
let age = 40
console.log( age++ ) // 40 , 즉] 출력후에 증가, 후위증가:현재 명령어단위에서 가장 마지막에 처리
console.log( ++age ) // 42 , 즉] 출력전에 증가, 선위증가: 현재 명령어 단위에서 먼저 처리
