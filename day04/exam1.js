...
if( 10 > 3 ){ 
    console.log( "3. 10 은 3보다 크다" ); console.log( "3.  [2] ")
}
...
else if( 10 > 2 ) { console.log( "5. 10은 1보다 크다" ); }
...
/*
let 정수1 = Number( prompt() ) // 1. 입력받기 2. 저장하기
let 정수2 = Number( prompt() )
let 결과 = 정수1 > 정수2        // 3. 처리
// 4. 출력( 더 큰 수 출력 ) 조건 : 첫번쨰 값이 두번째 값 보다 크면 , 참: 첫번째 값 , 거짓 : 두번째 값
...
let 선택번호 = Number( prompt( '좌석번호: 0~2' ) ) // 1. 입력받기 2. 저장하기 * 인덱스란? 배열 내 저장된 자료들의 순서 번호( 0번 시작 
let 결과 = seatList[선택번호] == 'X' // 3. 처리 : 입력받은 번호의 인덱스 값이 'x'이면
if( 결과 ) { console.log( '예약 성공' ) } // 4. 출력( 분기 )
else{ console.log( '예약실패' ); }
*/
...
// 조건 : 8세 미만: '무료' , 8세 이상 19세 이하: '5,000원'20세 이상 65세 미만: '10,000원' , 65세 이상: '3,000원'
/*
