...
// 여러개 자료들을 저장하는 방법 : 1. 배열[] 인덱스식별 2.  객체{} 속성명 식별
// 서로 다른 자료들의 의미/용도 다르면 객체 권장
// const person= { name : "구현승" , age : 26 , 'city' : '의왕'}
// console.log( person )
...
// let values = Object.values( book ) // 객체 내 모든 속성값 ( 배열) 반환
// for( let i = 0 ; i <= values.length - 1 ; i ++ ){ // 인덱스가 0부터 마지막 인덱스까지 1씩 증가 반복
...
// const person1 = { name: '김코딩', age: 25 };
// person1.email = 'sss@sss.com'
// delete person1.age
// console.log( person1 )
...
// console.log( user['job-title'] ) // 주의할점 : 속성명에 특수문자가 있거나 변수로 정의한 경우에는 .점이 아닌 [ ]대괄호 사용
...
// let 속성명목록 = Object.keys( inventory )
// for( let i = 0 ; i <= 속성명목록.length - 1 ; i ++ ){
//     let 속성명 = 속성명목록[i]; // i번쨰의 속성명 호출
//     if( inventory[속성명] < 10 ){ // i번째의 속성 값이 10 미만이면
//         console.log( 속성명 )
//     }
// }
/* 예제 10: 객체 배열 순회하기
...
let html = `<table>
            <tr> <th>동별</th> <th>세대수</th> <th>인구수(계)</th>
