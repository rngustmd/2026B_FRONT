...
let 결과1 = getWelcomeMessage('바보'); // 함수를 호출한 결과를 변수에 저장하고
console.log( 결과1 ) // 그 변수를 콘솔에 출력하시오
...
function isPositive( x ){           // 임의의 숫가 하나를 매개변수로 받아
    if( x > 0 ){ return true }      // 그 숫자가 0보다 크면 true 반환
